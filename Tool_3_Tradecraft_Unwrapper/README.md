...
The first stable release will be Version 1.0.0 after final documentation, cross-version testing, and release validation are complete.
...
https://github.com/GhostRF/Security_Tools/tree/tool3-tradecraft-unwrapper/Tool_3_Tradecraft_Unwrapper
